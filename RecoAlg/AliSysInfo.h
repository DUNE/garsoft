...
public:
  ...
  static void AddStamp(const char* sname,
                       Int_t id0 = -1,
                       Int_t id1 = -1,
                       Int_t id2 = -1,
                       Int_t id3 = -1);
  ...
  static void PrintJiraTable(TTree* tree,
                             const char* var,
                             const char* cut,
                             const char* format,
                             const char* output = "syswatch.table");
  //
  static void dumpBranchSize(FILE* pFile,
                             TBranch* branch,
                             const char* dumpName,
                             Float_t& totBytes,
                             Float_t& zipBytes,
  ...
  static void printTreeTable(const char* inputLog,
                             const char* mask,
                             Int_t nrows,
                             Int_t sortCol = 7,
                             Bool_t isJIRA = 1,
