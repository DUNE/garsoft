...
public:
  enum {
    ...
    ,
    kMultSec =
      0x4000000 //BIT(26): assumed to be secondary (due to the DCA) in multiplicity estimates
    ,
  ...
  virtual Float_t GetTPCClusterInfo(Int_t /*nNeighbours*/,
                                    Int_t /*type*/,
                                    Int_t /*row0*/ = 0,
                                    Int_t /*row1*/ = 159,
                                    Int_t /*type*/ = 0) const
  ...
  {
    return 0;
  } // return 0 if AliTPCdEdxInfo does not exist
  ...
  virtual Double_t GetTOFExpTDiff(Double_t /*b*/ = 0, Bool_t /*pidTPConly*/ = kTRUE) const
  {
    return kTOFBCNA * 25;
  }
