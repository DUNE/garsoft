...
public:
  ...
  AliExternalTrackParam(Double_t x,
                        Double_t alpha,
  ...
  Bool_t CorrectForMeanMaterialdEdx(Double_t xOverX0,
                                    Double_t xTimesRho,
                                    Double_t mass,
                                    Double_t dEdx,
                                    Bool_t anglecorr = kFALSE);

  Bool_t CorrectForMeanMaterialZA(Double_t xOverX0,
                                  Double_t xTimesRho,
                                  Double_t mass,
  ...
  Double_t GetPredictedChi2(const Double_t p[3],
  ...
  Bool_t RelateToVVertexBxByBzDCA(const AliVVertex* vtx,
                                  Double_t b[3],
                                  Double_t maxd,
  ...
  Bool_t PropagateToDCA(const AliVVertex* vtx,
                        Double_t b,
                        Double_t maxd,
                        Double_t dz[2] = 0,
                        Double_t cov[3] = 0);
  Bool_t PropagateToDCABxByBz(const AliVVertex* vtx,
                              Double_t b[3],
                              Double_t maxd,
                              Double_t dz[2] = 0,
                              Double_t cov[3] = 0);
  ...
  //Deprecated
  Bool_t CorrectForMaterial(Double_t d,
                            Double_t x0,
                            Double_t mass,
                            Double_t (*f)(Double_t) = AliExternalTrackParam::BetheBlochSolid);
  ...
  //
  virtual void FillPolymarker(TPolyMarker3D* pol,
                              Float_t magf,
                              Float_t minR,
                              Float_t maxR,
                              Float_t stepR);
...
inline void AliExternalTrackParam::ResetCovariance(Double_t s2)
{
  ...
  s2 = TMath::Abs(s2);
  Double_t fC0 = fC[0] * s2, fC2 = fC[2] * s2, fC5 = fC[5] * s2, fC9 = fC[9] * s2,
           fC14 = fC[14] * s2;
