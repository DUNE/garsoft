...
namespace gar {
  namespace rec {
    namespace alg {
      ...
      //----------------------------------------------------------------------------
      void KNNClusterAlg::PrepareAlgo(
        const std::vector<art::Ptr<gar::rec::Track>>& trkVector,
        ...
        std::unordered_map<const gar::rec::CaloHit*, art::Ptr<gar::rec::CaloHit>>& hitMaptoArtPtr)
      {
        ...
        for (std::vector<art::Ptr<gar::rec::Track>>::const_iterator iter = trkVector.begin(),
                                                                    iterEnd = trkVector.end();
             iter != iterEnd;
             ++iter) {
