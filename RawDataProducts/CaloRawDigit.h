...
namespace gar {
  namespace raw {
    ...
    public:
      ...
      CaloRawDigit(unsigned int ADC,
                   std::pair<float, float> time,
                   float x,
                   float y,
                   float z,
                   CellID_t cellID);
      CaloRawDigit(std::pair<unsigned int, unsigned int> ADC,
                   std::pair<float, float> time,
                   float x,
                   float y,
                   float z,
...
inline std::pair<unsigned int, unsigned int> gar::raw::CaloRawDigit::ADC() const
{
  return fADC;
}
inline std::pair<float, float> gar::raw::CaloRawDigit::Time() const
{
  return fTime;
}
inline float gar::raw::CaloRawDigit::X() const
{
  return fX;
}
inline float gar::raw::CaloRawDigit::Y() const
{
  return fY;
}
inline float gar::raw::CaloRawDigit::Z() const
{
  return fZ;
}
inline gar::raw::CellID_t gar::raw::CaloRawDigit::CellID() const
{
  return fCellID;
}
