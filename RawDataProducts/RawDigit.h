...
inline size_t gar::raw::RawDigit::NADC() const
{
  return fADC.size();
}
inline short gar::raw::RawDigit::ADC(int i) const
{
  return fADC.at(i);
}
inline gar::raw::RawDigit::ADCvector_t const& gar::raw::RawDigit::ADCs() const
{
  return fADC;
}
inline gar::raw::Channel_t gar::raw::RawDigit::Channel() const
{
  return fChannel;
}
inline ULong64_t gar::raw::RawDigit::Samples() const
{
  return fSamples;
}
inline float gar::raw::RawDigit::Pedestal() const
{
  return fPedestal;
}
inline float gar::raw::RawDigit::Sigma() const
{
  return fSigma;
}
inline ULong64_t gar::raw::RawDigit::Time() const
{
  return fTime;
}
inline gar::raw::Compress_t gar::raw::RawDigit::Compression() const
{
  return fCompression;
}
