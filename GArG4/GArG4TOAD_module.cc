...
#ifndef GARG4GARG4HTOAD
#define GARG4GARG4HTOAD 1
...
#include "GArG4/MaterialPropertyLoader_toad.h"
...
namespace gar {
  namespace garg4 {
    ...
    /**
        ...
        */
    class GArG4Toad : public ::art::EDProducer {
    public:
      /// Standard constructor and destructor for an FMWK module.
      explicit GArG4Toad(fhicl::ParameterSet const& pset);
      virtual ~GArG4Toad();
  ...
  namespace garg4 {
    ...
    //----------------------------------------------------------------------
    // Constructor
    GArG4Toad::GArG4Toad(fhicl::ParameterSet const& pset)
      : art::EDProducer{pset}
      , fG4Help(nullptr)
      , fEDepAction(nullptr)
    ...
    //----------------------------------------------------------------------
    void GArG4Toad::SetLimitsAndCuts()
    {
    ...
    void GArG4Toad::beginJob()
    {
      ...
      garg4::MaterialPropertyLoaderToad* MPL = new garg4::MaterialPropertyLoaderToad();
    ...
    //--------------------------------------------------------------------------
    void GArG4Toad::beginRun(::art::Run& /* run */)
    {
    ...
    //--------------------------------------------------------------------------
    std::unique_ptr<PositionInVolumeFilter> GArG4Toad::CreateParticleVolumeFilter(
      std::set<std::string> const& vol_names) const
    {
    ...
    //--------------------------------------------------------------------------
    void GArG4Toad::produce(::art::Event& evt)
    {
