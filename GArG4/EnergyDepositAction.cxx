...
namespace gar {
  ...
  namespace garg4 {
    ...
    {
      MF_LOG_DEBUG("EnergyDepositAction") << "EnergyDepositAction::SteppingAction";
      ...
      TGeoNode* node = geomanager->FindNode(
      ...
      if (step->GetTotalEnergyDeposit() * CLHEP::MeV / CLHEP::GeV > fEnergyCut) {
        ...
        MF_LOG_DEBUG("EnergyDepositAction")
          << "In volume " << VolumeName << " step size is " << step->GetStepLength() / CLHEP::cm
          << " cm and deposited " << step->GetTotalEnergyDeposit()
          << " MeV of energy with a minimum of " << fEnergyCut << " required.";
