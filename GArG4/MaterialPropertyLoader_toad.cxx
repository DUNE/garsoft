...
namespace gar {
  namespace garg4 {
    ...
    //----------------------------------------------
    void MaterialPropertyLoaderToad::SetMaterialProperty(std::string              const& Material,
    ...
    //--------------------------------------------------------------------------
    void MaterialPropertyLoaderToad::SetReflectances(std::string                                     const& /*Material*/,
