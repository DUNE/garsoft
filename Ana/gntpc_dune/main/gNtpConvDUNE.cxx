...
bool       gOptTruncateBigEvents = false; ///< For rooTracker output, truncate events with more entries than kNPmax?  Otherwise throw an error to avoid overruning a static array in the rooTracker tree.
