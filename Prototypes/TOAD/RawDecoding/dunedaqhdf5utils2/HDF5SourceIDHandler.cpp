...
namespace dunedaq {
  namespace hdf5libs {
    ...
    void HDF5SourceIDHandler::populate_source_id_geo_id_map(
      dunedaq::hdf5libs::hdf5rawdatafile::SrcIDGeoIDMap src_id_geo_id_mp_struct,
      source_id_geo_id_map_t& source_id_geo_id_map)
    {

      for (auto const& entry : src_id_geo_id_mp_struct) {
        daqdataformats::SourceID source_id(daqdataformats::SourceID::Subsystem::kDetectorReadout,
                                           entry.src_id);
        // FIXME: replace with a proper coder/decoder
        uint64_t geoid = (static_cast<uint64_t>(entry.geo_id.stream_id) << 48) |
                         (static_cast<uint64_t>(entry.geo_id.slot_id) << 32) |
                         (static_cast<uint64_t>(entry.geo_id.crate_id) << 16) | entry.geo_id.det_id;
        add_source_id_geo_id_to_map(source_id_geo_id_map, source_id, geoid);
      }
    }

    void HDF5SourceIDHandler::store_file_level_geo_id_info(HighFive::File& h5_file,
                                                           const source_id_geo_id_map_t& the_map)
    {
      write_attribute(h5_file, "source_id_geo_id_map", get_json_string(the_map));
    }

    void HDF5SourceIDHandler::store_record_header_source_id(
      HighFive::Group& record_group,
      const daqdataformats::SourceID& source_id)
    {
      write_attribute(record_group, "record_header_source_id", get_json_string(source_id));
    }

    void HDF5SourceIDHandler::store_record_level_path_info(HighFive::Group& record_group,
                                                           const source_id_path_map_t& the_map)
    {
      write_attribute(record_group, "source_id_path_map", get_json_string(the_map));
    }

    void HDF5SourceIDHandler::store_record_level_fragment_type_map(
      HighFive::Group& record_group,
    ...
    void HDF5SourceIDHandler::store_record_level_subdetector_map(
      HighFive::Group& record_group,
    ...
    void HDF5SourceIDHandler::fetch_file_level_geo_id_info(
      const HighFive::File& h5_file,
      source_id_geo_id_map_t& source_id_geo_id_map)
    {
      if (m_version >= 3) {
        try {
          std::string map_string =
            get_attribute<HighFive::File, std::string>(h5_file, "source_id_geo_id_map");
    ...
    void HDF5SourceIDHandler::fetch_record_level_geo_id_info(
      const HighFive::Group& /*record_group*/,
      source_id_geo_id_map_t& /*source_id_geo_id_map*/)
    {
      // In versions 3 and 4, there is no record-level geo_id information stored in the file
      if (m_version >= 3) { return; }
    }

    daqdataformats::SourceID HDF5SourceIDHandler::fetch_record_header_source_id(
      const HighFive::Group& record_group)
    {
      ...
      if (m_version >= 3) {
        try {
          std::string sid_string =
            get_attribute<HighFive::Group, std::string>(record_group, "record_header_source_id");
    ...
    void HDF5SourceIDHandler::fetch_source_id_path_info(const HighFive::Group& record_group,
                                                        source_id_path_map_t& source_id_path_map)
    {
      if (m_version >= 3) {
        try {
          std::string map_string =
            get_attribute<HighFive::Group, std::string>(record_group, "source_id_path_map");
    ...
    void HDF5SourceIDHandler::fetch_fragment_type_source_id_info(
      const HighFive::Group& record_group,
      fragment_type_source_id_map_t& fragment_type_source_id_map)
    {
      if (m_version >= 3) {
        try {
          std::string map_string = get_attribute<HighFive::Group, std::string>(
            record_group, "fragment_type_source_id_map");
    ...
    void HDF5SourceIDHandler::fetch_subdetector_source_id_info(
      const HighFive::Group& record_group,
      subdetector_source_id_map_t& subdetector_source_id_map)
    {
      if (m_version >= 3) {
        try {
          std::string map_string =
            get_attribute<HighFive::Group, std::string>(record_group, "subdetector_source_id_map");
    ...
    void HDF5SourceIDHandler::add_source_id_path_to_map(source_id_path_map_t& source_id_path_map,
                                                        const daqdataformats::SourceID& source_id,
    ...
    void HDF5SourceIDHandler::add_source_id_geo_id_to_map(
      source_id_geo_id_map_t& source_id_geo_id_map,
      const daqdataformats::SourceID& source_id,
    ...
    void HDF5SourceIDHandler::add_fragment_type_source_id_to_map(
      fragment_type_source_id_map_t& fragment_type_source_id_map,
    ...
    void HDF5SourceIDHandler::add_subdetector_source_id_to_map(
      subdetector_source_id_map_t& subdetector_source_id_map,
    ...
    void HDF5SourceIDHandler::add_subsystem_source_id_to_map(
      subsystem_source_id_map_t& subsystem_source_id_map,
    ...
    std::string HDF5SourceIDHandler::get_json_string(const daqdataformats::SourceID& source_id)
    {
    ...
    std::string HDF5SourceIDHandler::get_json_string(
      const HDF5SourceIDHandler::source_id_path_map_t& the_map)
    {
      ...
      for (auto const& map_element : the_map) {
        ...
        json_element.subsys =
          static_cast<uint32_t>(map_element.first.subsystem); // NOLINT(build/unsigned)
    ...
    std::string HDF5SourceIDHandler::get_json_string(
      const HDF5SourceIDHandler::source_id_geo_id_map_t& the_map)
    {
    ...
    std::string HDF5SourceIDHandler::get_json_string(
      const HDF5SourceIDHandler::fragment_type_source_id_map_t& the_map)
    {
      ...
      for (auto const& map_element : the_map) {
        ...
        for (auto const& source_id_from_map : map_element.second) {
          ...
          json_source_id.subsys =
            static_cast<uint32_t>(source_id_from_map.subsystem); // NOLINT(build/unsigned)
    ...
    std::string HDF5SourceIDHandler::get_json_string(
      const HDF5SourceIDHandler::subdetector_source_id_map_t& the_map)
    {
    ...
    void HDF5SourceIDHandler::parse_json_string(const std::string& json_string,
                                                daqdataformats::SourceID& source_id)
    {
      hdf5sourceidmaps::SourceID json_struct;
      ...
      daqdataformats::SourceID::Subsystem subsys =
        static_cast<daqdataformats::SourceID::Subsystem>(json_struct.subsys);
      daqdataformats::SourceID::ID_t id =
        static_cast<daqdataformats::SourceID::ID_t>(json_struct.id);
                                                ...
                                                source_id_path_map_t& source_id_path_map)
    {
      ...
      for (auto const& json_element : json_struct.map_entries) {
        ...
        daqdataformats::SourceID::ID_t id =
          static_cast<daqdataformats::SourceID::ID_t>(json_element.id);
    ...
    void HDF5SourceIDHandler::parse_json_string(
      ...
      fragment_type_source_id_map_t& fragment_type_source_id_map)
    {
      ...
      for (auto const& json_element : json_struct.map_entries) {
        ...
        for (hdf5sourceidmaps::SourceID json_source_id : json_source_id_list) {
          ...
          daqdataformats::SourceID::ID_t id =
            static_cast<daqdataformats::SourceID::ID_t>(json_source_id.id);
          daqdataformats::SourceID source_id(subsys, id);
