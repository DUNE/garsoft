 ...
 */
    ...
    public:
      ...
      typedef std::map<daqdataformats::SourceID, std::vector<uint64_t>>
        source_id_geo_id_map_t; // NOLINT(build/unsigned)
      typedef std::map<daqdataformats::SourceID::Subsystem, std::set<daqdataformats::SourceID>>
        subsystem_source_id_map_t;
      typedef std::map<daqdataformats::FragmentType, std::set<daqdataformats::SourceID>>
        fragment_type_source_id_map_t;
      typedef std::map<detdataformats::DetID::Subdetector, std::set<daqdataformats::SourceID>>
   ...
   */
      static void populate_source_id_geo_id_map(
   ...
   */
      void fetch_file_level_geo_id_info(const HighFive::File& h5_file,
                                        source_id_geo_id_map_t& the_map);
   ...
   */
      void fetch_record_level_geo_id_info(const HighFive::Group& record_group,
                                          source_id_geo_id_map_t& the_map);
   ...
   * stored at the record level in the specified HighFive::Group.
   */
      void fetch_source_id_path_info(const HighFive::Group& record_group,
   ...
   * stored at the record level in the specified HighFive::Group.
   */
      void fetch_fragment_type_source_id_info(const HighFive::Group& record_group,
   ...
   * stored at the record level in the specified HighFive::Group.
   */
      void fetch_subdetector_source_id_info(const HighFive::Group& record_group,
   ...
   */
      static void add_fragment_type_source_id_to_map(
   ...
   */
      static void add_subdetector_source_id_to_map(
   ...
   */
      static void add_subsystem_source_id_to_map(
   ...
   */
      static std::string get_json_string(
        const fragment_type_source_id_map_t& fragment_type_source_id_map);

      /**
   * Produces the JSON string that corresponds to the specified subdetector_source_id map
   */
      static std::string get_json_string(
        const subdetector_source_id_map_t& subdetector_source_id_map);
   ...
   */
      ...
      static void write_attribute(HighFive::AnnotateTraits<C>& h5annt,
   ...
   */
    ...
    template <typename C, typename T>
    void HDF5SourceIDHandler::write_attribute(HighFive::AnnotateTraits<C>& h5annt,
                                              const std::string& name,
                                              T value)
    {
      if (!(h5annt.hasAttribute(name))) h5annt.createAttribute(name, value);
      // else
      //   ers::warning(HDF5AttributeExists(ERS_HERE, name));
    }

    template <typename C, typename T>
    T HDF5SourceIDHandler::get_attribute(const HighFive::AnnotateTraits<C>& h5annt,
                                         const std::string& name)
    {
