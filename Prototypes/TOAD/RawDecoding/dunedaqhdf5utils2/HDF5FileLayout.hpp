...
namespace dunedaq {
   ...
   */
      explicit HDF5FileLayout(hdf5filelayout::FileLayoutParams conf,
                              uint32_t version = 4); // NOLINT(build/unsigned)
      ...
      std::map<daqdataformats::SourceID::Subsystem, hdf5filelayout::PathParams>
   ...
   */
      std::vector<std::string> get_path_elements(
   ...
   */
      daqdataformats::SourceID get_source_id_from_path_elements(
   ...
   */
      std::string get_trigger_record_header_path(
