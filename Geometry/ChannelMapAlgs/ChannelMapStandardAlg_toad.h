...
////////////////////////////////////////////////////////////////////////
#ifndef GEO_CHANNELSTANDARDMAPALGTOAD_H
#define GEO_CHANNELSTANDARDMAPALGTOAD_H
...
namespace gar{
    namespace geo{
        namespace seg{
            ...
            class ChannelMapStandardAlgToad : public ChannelMapAlg{

            public:

                ChannelMapStandardAlgToad(fhicl::ParameterSet const& p);
	      ...
	      // commented to make clang happy UInt_t              fNumChansCenter;             ///< Number of channels in center hole filler
