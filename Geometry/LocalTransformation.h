  ...
  namespace geo {
    ...
    public:
      ...
      /**
            * @brief Constructor
            */
      LocalTransformation() : fGeoMatrix(nullptr) {}
      ...
      static TransformationMatrix_t transformationFromPath(std::vector<TGeoNode const*> const& path,
                                                           size_t depth);
      ...
      //Set the matrix
      void SetMatrix(TransformationMatrix_t matrix) { fGeoMatrix = matrix; }
