...
// class header
#include "Geometry/StandardGeometryHelperGArToad.h"

// GArSoft libraries
#include "Geometry/ChannelMapAlgs/ChannelMapStandardAlg_toad.h"
...
namespace gar {
  namespace geo {
    ...
    //----------------------------------------------------------------------------
    StandardGeometryHelperGArToad::StandardGeometryHelperGArToad(fhicl::ParameterSet const& pset,
    ...
    //----------------------------------------------------------------------------
    void StandardGeometryHelperGArToad::doConfigureChannelMapAlg(
      fhicl::ParameterSet const& sortingParameters,
      geo::GeometryCore* geom)
    {
      fChannelMap.reset();

      fChannelMap = std::make_shared<gar::geo::seg::ChannelMapStandardAlgToad>(sortingParameters);
    ...
    //----------------------------------------------------------------------------
    StandardGeometryHelperGArToad::ChannelMapAlgPtr_t
    StandardGeometryHelperGArToad::doGetChannelMapAlg() const
    {
      return fChannelMap;
    }

    //----------------------------------------------------------------------------
    void StandardGeometryHelperGArToad::doConfigureECALSegmentationAlg(
      fhicl::ParameterSet const& segParameters,
      geo::GeometryCore* geom)
    {
      ...
      if (SegmentationAlgName.compare("GridXY") == 0)
        fECALSegmentationAlg =
          std::make_shared<gar::geo::seg::SegmentationGridXYAlg>(segParameters);
      else if (SegmentationAlgName.compare("MultiGridStripXY") == 0)
        fECALSegmentationAlg =
          std::make_shared<gar::geo::seg::SegmentationMultiGridStripXYAlg>(segParameters);
      else {
    ...
    //----------------------------------------------------------------------------
    void StandardGeometryHelperGArToad::doConfigureMinervaSegmentationAlg(
      fhicl::ParameterSet const& segParameters,
      geo::GeometryCore* geom)
    {
      ...
      if (SegmentationAlgName.compare("Minerva") == 0)
        fMinervaSegmentationAlg =
          std::make_shared<gar::geo::seg::MinervaSegmentationAlg>(segParameters);
      else {
        throw cet::exception("StandardGeometryHelperGArToad::doConfigureMinervaSegmentationAlg")
    ...
    //----------------------------------------------------------------------------
    void StandardGeometryHelperGArToad::doConfigureMuIDSegmentationAlg(
      fhicl::ParameterSet const& segParameters,
      geo::GeometryCore* geom)
    {
      ...
      if (SegmentationAlgName.compare("SegmentationStripXAlg") == 0)
        fMuIDSegmentationAlg =
          std::make_shared<gar::geo::seg::SegmentationStripXAlg>(segParameters);
      else if (SegmentationAlgName.compare("SegmentationStripYAlg") == 0)
        fMuIDSegmentationAlg =
          std::make_shared<gar::geo::seg::SegmentationStripYAlg>(segParameters);
        ...
        throw cet::exception("StandardGeometryHelperGArToad::doConfigureMuIDSegmentationAlg")
    ...
    //----------------------------------------------------------------------------
    StandardGeometryHelperGArToad::SegmentationAlgPtr_t
    StandardGeometryHelperGArToad::doGetECALSegmentationAlg() const
    {
    ...
    //----------------------------------------------------------------------------
    StandardGeometryHelperGArToad::SegmentationAlgPtr_t
    StandardGeometryHelperGArToad::doGetMinervaSegmentationAlg() const
    {
    ...
    //----------------------------------------------------------------------------
    StandardGeometryHelperGArToad::SegmentationAlgPtr_t
    StandardGeometryHelperGArToad::doGetMuIDSegmentationAlg() const
    {
...
DEFINE_ART_SERVICE_INTERFACE_IMPL(gar::geo::StandardGeometryHelperGArToad,
