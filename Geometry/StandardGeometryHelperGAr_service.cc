...
namespace gar {
  namespace geo {
    ...
    //----------------------------------------------------------------------------
    void StandardGeometryHelperGAr::doConfigureChannelMapAlg(
    ...
    //----------------------------------------------------------------------------
    StandardGeometryHelperGAr::ChannelMapAlgPtr_t StandardGeometryHelperGAr::doGetChannelMapAlg()
      const
    {
      return fChannelMap;
    }
    ...
    //----------------------------------------------------------------------------
    void StandardGeometryHelperGAr::doConfigureECALSegmentationAlg(
    ...
    //----------------------------------------------------------------------------
    void StandardGeometryHelperGAr::doConfigureMinervaSegmentationAlg(
      fhicl::ParameterSet const& segParameters,
      geo::GeometryCore* geom)
    {
    ...
    //----------------------------------------------------------------------------
    void StandardGeometryHelperGAr::doConfigureMuIDSegmentationAlg(
      fhicl::ParameterSet const& segParameters,
      geo::GeometryCore* geom)
    {
    ...
    //----------------------------------------------------------------------------
    StandardGeometryHelperGAr::SegmentationAlgPtr_t
    StandardGeometryHelperGAr::doGetECALSegmentationAlg() const
    {
    ...
    //----------------------------------------------------------------------------
    StandardGeometryHelperGAr::SegmentationAlgPtr_t
    StandardGeometryHelperGAr::doGetMinervaSegmentationAlg() const
    {
    ...
    //----------------------------------------------------------------------------
    StandardGeometryHelperGAr::SegmentationAlgPtr_t
    StandardGeometryHelperGAr::doGetMuIDSegmentationAlg() const
    {
...
DEFINE_ART_SERVICE_INTERFACE_IMPL(gar::geo::StandardGeometryHelperGAr,
