  ...
  namespace geo {
    ...
    public:
      ...
      /**
            ...
            */
      void ConfigureChannelMapAlg(fhicl::ParameterSet const& sortingParameters,
      ...
      void ConfigureECALSegmentationAlg(fhicl::ParameterSet const& segParameters,
                                        geo::GeometryCore* geom);

      SegmentationAlgPtr_t GetECALSegmentationAlg() const;

      void ConfigureMinervaSegmentationAlg(fhicl::ParameterSet const& segParameters,
                                           geo::GeometryCore* geom);

      SegmentationAlgPtr_t GetMinervaSegmentationAlg() const;

      void ConfigureMuIDSegmentationAlg(fhicl::ParameterSet const& segParameters,
                                        geo::GeometryCore* geom);
    ...
    //-------------------------------------------------------------------------------------------
    inline void ExptGeoHelperInterface::ConfigureChannelMapAlg(
    ...
    //-------------------------------------------------------------------------------------------
    inline ExptGeoHelperInterface::ChannelMapAlgPtr_t ExptGeoHelperInterface::GetChannelMapAlg()
      const
    {
    ...
    //-------------------------------------------------------------------------------------------
    inline void ExptGeoHelperInterface::ConfigureECALSegmentationAlg(
    ...
    //-------------------------------------------------------------------------------------------
    inline ExptGeoHelperInterface::SegmentationAlgPtr_t
    ExptGeoHelperInterface::GetECALSegmentationAlg() const
    {
      return doGetECALSegmentationAlg();
    }

    //-------------------------------------------------------------------------------------------
    inline void ExptGeoHelperInterface::ConfigureMinervaSegmentationAlg(
      fhicl::ParameterSet const& segParameters,
      gar::geo::GeometryCore* geom)
    {
    ...
    //-------------------------------------------------------------------------------------------
    inline ExptGeoHelperInterface::SegmentationAlgPtr_t
    ExptGeoHelperInterface::GetMinervaSegmentationAlg() const
    {
      return doGetMinervaSegmentationAlg();
    }

    //-------------------------------------------------------------------------------------------
    inline void ExptGeoHelperInterface::ConfigureMuIDSegmentationAlg(
      fhicl::ParameterSet const& segParameters,
      gar::geo::GeometryCore* geom)
    {
    ...
    //-------------------------------------------------------------------------------------------
    inline ExptGeoHelperInterface::SegmentationAlgPtr_t
    ExptGeoHelperInterface::GetMuIDSegmentationAlg() const
    {
