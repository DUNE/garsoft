...
#ifndef COREUTILS_SERVICEPROVIDERWRAPPERS_H
#define COREUTILS_SERVICEPROVIDERWRAPPERS_H 1

// GArSoft libraries
#include "CoreUtils/ServiceUtil.h" // gar::providerFrom() (for includers)
...
namespace gar {
  ...
  /** **********************************************************************
    ...
    *
    * This class provides the simplest possible art service to wrap a GArSoft
    * service provider.
    ...
    * - a `provider_type` definition (required by `gar::providerFrom()`)
  ...
  /** **********************************************************************
    ...
    * It only adds support for `gar::providerFrom()` function.
    *
  ...
  /** *************************************************************************
    ...
    *
    * In the factorization model recommended in GArSoft, this hierarchy of art
    ...
    *     namespace myprov {
    *
    *       using MyServiceA = gar::ServiceProviderImplementationWrapper
...
#endif // COREUTILS_SERVICEPROVIDERWRAPPERS_H
