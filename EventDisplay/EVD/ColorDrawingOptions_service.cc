...
namespace gar {
  namespace evd {
    ...
    ColorDrawingOptions::ColorDrawingOptions(fhicl::ParameterSet const& pset,
      ...
      , fColorScaleRaw(evdb::ColorScale(fRawQLow,
                                        fRawQHigh,
                                        evdb::kBlueToRedII,
                                        evdb::kLinear,
                                        fRawDiv,
      ...
      , fGrayScaleRaw(evdb::ColorScale(fRawQLow,
                                       fRawQHigh,
                                       evdb::kLinGray,
                                       evdb::kLinear,
                                       fRawDiv,
      ...
      // starting with low color wheel value
      , fColorScaleReco(evdb::ColorScale(fRecoQLow,
                                         fRecoQHigh,
                                         evdb::kBlueToRedII,
                                         evdb::kLinear,
                                         fRecoDiv,
                                         ...
                                         0.65,
                                         0.25))
      , fGrayScaleReco(evdb::ColorScale(fRecoQLow,
                                        fRecoQHigh,
                                        evdb::kLinGray,
                                        evdb::kLinear,
                                        fRecoDiv,
    ...
    void ColorDrawingOptions::reconfigure(fhicl::ParameterSet const& pset)
    {
      ...
      fGrayScaleReco = evdb::ColorScale(
        fRecoQLow, fRecoQHigh, evdb::kLinGray, evdb::kLinear, fRecoDiv, 270.0, 0.0, 0.5, 0.5);
