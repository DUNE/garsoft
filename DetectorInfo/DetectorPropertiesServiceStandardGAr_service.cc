...
namespace gar {
  namespace detinfo {
    ...
    //--------------------------------------------------------------------
    DetectorPropertiesServiceStandardGAr::DetectorPropertiesServiceStandardGAr(
    ...
    //-------------------------------------------------------------
    void DetectorPropertiesServiceStandardGAr::preProcessEvent(const ::art::Event&,
                                                               art::ScheduleContext)
    {
    ...
    bool DetectorPropertiesServiceStandardGAr::isDetectorPropertiesServiceStandardGAr(
