...
//
////////////////////////////////////////////////////////////////////////
#ifndef DETECTORPROPERTIESSERVICESTANDARDTOAD_H
#define DETECTORPROPERTIESSERVICESTANDARDTOAD_H
...
namespace gar {
  namespace detinfo{
    ...
    class DetectorPropertiesServiceStandardGArToad : public DetectorPropertiesService {
    ...
    public:
      ...
      struct ServiceConfiguration_t {
        ...
        detinfo::DetectorPropertiesStandardToad::Configuration_t ProviderConfiguration;
      ...
      DetectorPropertiesServiceStandardGArToad(fhicl::ParameterSet const& pset,
    ...
    private:
      ...
      std::unique_ptr<detinfo::DetectorPropertiesStandardToad> fProp;
...
DECLARE_ART_SERVICE_INTERFACE_IMPL(gar::detinfo::DetectorPropertiesServiceStandardGArToad,
