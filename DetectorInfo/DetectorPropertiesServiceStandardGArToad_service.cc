...
// GArSoft includes
#include "DetectorInfo/DetectorPropertiesServiceStandardGArToad.h"
...
namespace gar {
  namespace detinfo{
    ...
    //--------------------------------------------------------------------
    DetectorPropertiesServiceStandardGArToad::DetectorPropertiesServiceStandardGArToad(fhicl::ParameterSet const& pset,
                                                                         ::art::ActivityRegistry    &reg)
    : fInheritNumberTimeSamples(pset.get<bool>("InheritNumberTimeSamples", false))
    {
      // Register for callbacks.

      reg.sPostOpenFile.watch    (this, &DetectorPropertiesServiceStandardGArToad::postOpenFile);
      reg.sPreProcessEvent.watch (this, &DetectorPropertiesServiceStandardGArToad::preProcessEvent);
      fProp = std::make_unique<detinfo::DetectorPropertiesStandardToad>(pset,
    ...
    //--------------------------------------------------------------------
    void DetectorPropertiesServiceStandardGArToad::reconfigure(fhicl::ParameterSet const& p)
    {
    ...
    //-------------------------------------------------------------
    void DetectorPropertiesServiceStandardGArToad::preProcessEvent(const ::art::Event& , art::ScheduleContext)
    {
    ...
    void DetectorPropertiesServiceStandardGArToad::postOpenFile(const std::string& filename)
    {
    ...
    bool DetectorPropertiesServiceStandardGArToad::isDetectorPropertiesServiceStandardGAr(const fhicl::ParameterSet& ps) const
    {
...
DEFINE_ART_SERVICE_INTERFACE_IMPL(gar::detinfo::DetectorPropertiesServiceStandardGArToad,
