...
namespace gar {
  namespace detinfo {
    ...
    //--------------------------------------------------------------------
    DetectorPropertiesServiceStandardGArToad::DetectorPropertiesServiceStandardGArToad(
      ...
      : fInheritNumberTimeSamples(pset.get<bool>("InheritNumberTimeSamples", false))
    {
      ...
      fProp = std::make_unique<detinfo::DetectorPropertiesStandardToad>(
        pset,
    ...
    //-------------------------------------------------------------
    void DetectorPropertiesServiceStandardGArToad::preProcessEvent(const ::art::Event&,
                                                                   art::ScheduleContext)
    {
      ...
      if (filename.size() != 0) {
        ...
        if (file != 0 && !file->IsZombie() && file->IsOpen()) {
          ...
          while (sqlite3_step(stmt) == SQLITE_ROW) {
            ...
            auto ps = fhicl::ParameterSet::make(
    ...
    bool DetectorPropertiesServiceStandardGArToad::isDetectorPropertiesServiceStandardGAr(
      const fhicl::ParameterSet& ps) const
    {
      ...
      return (ps.get<std::string>("service_type", "") == "DetectorPropertiesService") &&
             (ps.get<std::string>("service_provider", "") ==
