...
namespace gar {
  namespace detinfo{
    ...
    //--------------------------------------------------------------------
    DetectorPropertiesStandardToad::DetectorPropertiesStandardToad(fhicl::ParameterSet      const& pset,
    ...
    DetectorPropertiesStandardToad::ValidateConfiguration(fhicl::ParameterSet   const& p,
                                                      std::set<std::string> const& ignore_params /* = {} */)
    {
    ...
    //--------------------------------------------------------------------
    void DetectorPropertiesStandardToad::ValidateAndConfigure(fhicl::ParameterSet    const& p,
                                                          std::set<std::string> const& ignore_params /* = {} */)
    {
    ...
    //
    double DetectorPropertiesStandardToad::Eloss(double mom,
                                             double mass,
                                             double tcut) const
    {
      // Some constants.
    ...
    //----------------------------------------------------------------------------------
    double DetectorPropertiesStandardToad::ElossVar(double mom,
                                                double mass) const
    {
      // Some constants.
