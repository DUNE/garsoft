...
#include "DetectorInfo/DetectorPropertiesStandardToad.h"
...
namespace gar {
  namespace detinfo {
    ...
    //--------------------------------------------------------------------
    DetectorPropertiesStandardToad::DetectorPropertiesStandardToad()
      : fGP(0)
      //, fECALP(0)
      , fClocks(0)
      , fGeo(0)
    ...
    DetectorPropertiesStandardToad::DetectorPropertiesStandardToad(
      ...
      std::set<std::string> const& ignore_params /* = {} */)
      : DetectorPropertiesStandardToad(pset,
    ...
    //--------------------------------------------------------------------
    bool DetectorPropertiesStandardToad::Update(uint64_t)
    {
    ...
    //--------------------------------------------------------------------
    bool DetectorPropertiesStandardToad::UpdateClocks(const detinfo::DetectorClocks* clks)
    {
      fClocks = clks;
    ...
    //------------------------------------------------------------
    double DetectorPropertiesStandardToad::ConvertTDCToTicks(double tdc) const
    {
      return fClocks->TPCTDC2Tick(tdc);
    }

    //--------------------------------------------------------------
    double DetectorPropertiesStandardToad::ConvertTicksToTDC(double ticks) const
    {
      return fClocks->TPCTick2TDC(ticks);
    }

    //--------------------------------------------------------------------
    void DetectorPropertiesStandardToad::Configure(Configuration_t const& config)
    {
    ...
    //--------------------------------------------------------------------
    DetectorPropertiesStandardToad::Configuration_t
    DetectorPropertiesStandardToad::ValidateConfiguration(
    ...
    //--------------------------------------------------------------------
    void DetectorPropertiesStandardToad::ValidateAndConfigure(
      fhicl::ParameterSet const& p,
      std::set<std::string> const& ignore_params /* = {} */)
    {
    ...
    //------------------------------------------------------------------------------------//
    void DetectorPropertiesStandardToad::Setup(providers_type providers)
    {
    ...
    } // DetectorPropertiesStandardToad::Setup()

    //------------------------------------------------------------------------------------//
    double DetectorPropertiesStandardToad::Efield(unsigned int planegap) const
    {
    ...
    double DetectorPropertiesStandardToad::Density(double temperature, double pressure) const
    {
      ...
      double density =
        0.01645 + 0.00167678 * (pressure - 10.0) - 0.00005828 * (temperature - 294.0);
    ...
    //
    double DetectorPropertiesStandardToad::Eloss(double mom, double mass, double tcut) const
    {
      // Some constants.
      ...
      double B =
        0.5 * std::log(2. * me * bg * bg * tcut / (1.e-12 * sqr(fGP->ExcitationEnergy()))) -
      ...
      return dedx;
    } // DetectorPropertiesStandardToad::Eloss()

    //----------------------------------------------------------------------------------
    double DetectorPropertiesStandardToad::ElossVar(double mom, double mass) const
    {
      // Some constants.
      ...
      double result = gamma2 * (1. - 0.5 * beta2) * me * (fGP->AtomicNumber() / fGP->AtomicMass()) *
                      K * Density();
      return result;
    } // DetectorPropertiesStandardToad::ElossVar()
                                                         ...
                                                         bool cmPerns) const
    {
      ...
      double vd =
        fDriftVelocity; // cm/us.  For now just take it out of a fcl parameter.  Calculated with Magboltz and it's a strong function of gas composition
    ...
    //------------------------------------------------------------------------------------//
    int DetectorPropertiesStandardToad::TriggerOffset() const
    {
    ...
    double DetectorPropertiesStandardToad::ConvertXToTicks(double X) const
    {
    ...
    double DetectorPropertiesStandardToad::ConvertTicksToX(double ticks) const
    {
      return ticks * fXTicksCoefficient;
    }

    //--------------------------------------------------------------------
    void DetectorPropertiesStandardToad::CheckIfConfigured() const
    {
    ...
    void DetectorPropertiesStandardToad::CalculateXTicksParams()
    {
      CheckIfConfigured();
