...
namespace gar {
  namespace detinfo {
    ...
    DetectorPropertiesStandard::DetectorPropertiesStandard()
      : fGP(0), fECALP(0), fClocks(0), fGeo(0)
    {}
    ...
    DetectorPropertiesStandard::DetectorPropertiesStandard(
      ...
      : fGP(gp), fECALP(ecalp), fClocks(c), fGeo(geo)
    {
      {
    ...
    //--------------------------------------------------------------------
    DetectorPropertiesStandard::Configuration_t DetectorPropertiesStandard::ValidateConfiguration(
