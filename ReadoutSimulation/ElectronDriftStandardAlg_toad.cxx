...
namespace gar {
  namespace rosim {
    ...
    //--------------------------------------------------------------------------
    void ElectronDriftStandardAlgToad::DriftElectronsToReadout(gar::sdp::EnergyDeposit       const& dep,
                                                           gar::rosim::ElectronDriftInfo      & driftInfo)
    {
      ...
      MF_LOG_DEBUG("ElectronDriftStandardAlgToad::DriftElectronsToReadout") << "energy deposition: " 
