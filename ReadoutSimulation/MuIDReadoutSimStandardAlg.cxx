...
namespace gar {
  namespace rosim {
    ...
    //----------------------------------------------------------------------------
    MuIDReadoutSimStandardAlg::MuIDReadoutSimStandardAlg(CLHEP::HepRandomEngine& engine,
    ...
    //----------------------------------------------------------------------------
    void MuIDReadoutSimStandardAlg::PrepareAlgo(
    ...
    //----------------------------------------------------------------------------
    raw::CaloRawDigit* MuIDReadoutSimStandardAlg::DoStripDigitization(float x,
                                                                      float y,
                                                                      float z,
                                                                      float energy,
                                                                      float time,
    ...
    //----------------------------------------------------------------------------
    float MuIDReadoutSimStandardAlg::DoPhotonStatistics(float x,
                                                        float y,
                                                        float z,
                                                        float energy) const
    {
    ...
    MuIDReadoutSimStandardAlg::CalculatePosition(float x, float y, float z, raw::CellID_t cID) const
    {
      bool drop = false;
    ...
    //----------------------------------------------------------------------------
    std::pair<float, float> MuIDReadoutSimStandardAlg::DoLightPropagation(float x,
                                                                          float y,
                                                                          float z,
                                                                          float time,
                                                                          raw::CellID_t cID) const
