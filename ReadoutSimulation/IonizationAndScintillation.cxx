  ...
  namespace rosim {
    ...
    void IonizationAndScintillation::reconfigure(fhicl::ParameterSet const& pset)
    {
      ...
      if (calcName.compare("NEST") == 0)
        ...
        MF_LOG_WARNING("IonizationAndScintillation") << "No ISCalculation set, this can't be good.";
    ...
    void IonizationAndScintillation::Reset(const gar::sdp::EnergyDeposit* dep)
    {
      ...
      if (fEnergyDeposit->Energy() > 0) {
        ...
        fElectronsPerEDep->Fill(fISCalc->NumberIonizationElectrons() * 1.e-3 /
                                fISCalc->EnergyDeposit());
        fPhotonsPerEDep->Fill(fISCalc->NumberScintillationPhotons() * 1.e-3 /
                              fISCalc->EnergyDeposit());
